        ...
        <div class="container-fluid">
          ...
          <div class="main-content">
                        ...
                        ?>
                          <a href="javascript:void(0);" class="list-group-item list-group-item-action border-0" onclick="loadConversation('<?php echo $res['uniqueID']; ?>');">
                            ...
                            <div class="d-flex align-items-start">
                              <img src="<?php echo $res['profile_picture']; ?>" class="rounded-circle mr-1" alt="<?php echo $res['first_name'] . ' ' . $res['middle_name'] . ' ' . $res['last_name']; ?>" width="40" height="40">
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="footer">
                  <p>2024 © Admin Board. - <a href="#">example.com</a></p>
                </div>
              </div>
            </div>
          </div>
...
<script>
  function loadConversation(user_uniqueId_receiver) {
    ...
    window.location.href = 'stud_message.php?userUNIQUEid_receiver=' + user_uniqueId_receiver;
  }
  ...
  function loadSelectedUserConversation() {
    ...
    if (user_uniqueId_receiver) {
      ...
      $.ajax({
        url: 'stud_messageLIVECHAT.php', // Replace with the actual URL to load conversation data
        method: 'POST',
        data: {
