...
if (isset($_POST['receiver_id'])) {
    ...
    $stmt = $conn->prepare("SELECT * FROM chat_system LEFT JOIN students_data ON students_data.uniqueID = chat_system.sender_id WHERE (chat_system.sender_id = ? AND chat_system.receiver_id = ?) OR (chat_system.sender_id = ? AND chat_system.receiver_id = ?) ORDER BY chat_system.id ASC");
