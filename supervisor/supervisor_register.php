            ...
            <h5>Supervisor Login</h5>
              ...
              <form action="../php/supervisor_registerCode.php" method="POST" enctype="multipart/form-data" class="u-clearfix u-form-spacing-20 u-form-vertical u-inner-form" style="padding: 10px">
                ...
                <div class="u-form-group u-form-partition-factor-3 u-label-none u-form-group-4">
                  <label for="text-7a3c" class="u-label">Company Name</label>
                  <input type="text" placeholder="Company Name" id="text-7a3c" name="companyNAME" class="u-border-2 u-border-black u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-input-4" required="true">
                </div>
                ...
                <div class="u-form-group u-form-partition-factor-3 u-label-none u-form-group-6">
                  <label for="text-63ba" class="u-label">Company Address</label>
                  <input type="text" placeholder="Company Address" id="text-63ba" name="companyADDRESS" class="u-border-2 u-border-black u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-input-6" required="true">
                </div>
                ...
                <div class="u-form-group u-form-partition-factor-3 u-label-none u-form-group-11">
                  ...
                  <input type="file" accept="image/*" id="text-df1c" name="supervisor_pic" class="u-border-2 u-border-black u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-input-11" required="true">
                </div>
