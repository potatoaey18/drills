...
<script>
  function loadConversation(user_uniqueId_receiver) {
    ...
    window.location.href = 'supervisor_stud_message.php?userUNIQUEid_receiver=' + user_uniqueId_receiver;
  }
  ...
  function loadSelectedUserConversation() {
    ...
    if (user_uniqueId_receiver) {
      ...
      $.ajax({
        url: 'supervisor_messageLIVECHAT.php', // Replace with the actual URL to load conversation data
        method: 'POST',
        data: {
