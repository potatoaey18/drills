    ...
    <div class="content-wrap">
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Students OJT Requirements</li>
                                </ol>
                            </div>
                        </div>
                    </div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $result['stud_email'] ?></td>
                <td>
                    <a href="VIEWojt_requirements.php?student_ID=<?= $result['id'] ?>" class="btn btn-primary">View Documents</a>
                </td>
            </tr>
            <?php
            }
