...
$(document).ready(function() {
    ...
    $("#sendButton").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "send_supervisor_image_to_student.php",
            data: formData,
           ...
           $(function(){
            var receiverId = <?php echo json_encode($receiverId); ?>;
             setInterval(function(){
              $.ajax({
                type: "POST",
                url: "supervisor_load_NewMessage.php", // Create a separate PHP file to check for new messages
    ...
    $("#messageForm").submit(function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "send_supervisorTOuser_chat.php",
