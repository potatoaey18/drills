...
<head>
    ...
    <title>OJT Web Portal: Student Trainees</title>
    <!-- ================= Favicon ================== -->
    <!-- Standard -->
    ...
    <div class="content-wrap">
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Student Trainee</li>
                                </ol>
                            </div>
                        </div>
                    </div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="supervisor_stud_profile.php?student_ID=<?= $result['id'] ?>" class="btn btn-primary">View Profile</a>
                </td>
            </tr>
            <?php
            }
