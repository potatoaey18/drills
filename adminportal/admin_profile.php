...
<div class="col-md-4">
<img alt="" id="myImage" style="width:600px;" title="" class="img-circle img-thumbnail isTooltip" src="<?php echo $data['admin_profile_picture']; ?>" data-original-title="Usuario">
