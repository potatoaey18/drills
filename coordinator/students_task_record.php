...
<head>
    ...
    <title>OJT Web Portal: Student Task Records</title>
    <!-- ================= Favicon ================== -->
    <!-- Standard -->
    ...
    <div class="content-wrap">
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Students Task Record</li>
                                </ol>
                            </div>
                        </div>
                    </div>
        ...
        ?>
            <tr>
                ...
                <td>
                <a href="coordinator_stud_task_list.php?student_ID=<?= $result['id'] ?>" class="btn btn-primary">View Task Record</a>
                </td>
