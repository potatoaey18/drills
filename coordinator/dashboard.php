                ...
                <section id="main-content">
                        ...
                        <div class="col-lg-3">
                            <div class="card">
                                <div class="stat-widget-one">
                                    ...
                                    <div class="stat-content dib">
                                        <div class="stat-text">Deployed</div>
                                        <?php
                                        $course_handled = $_SESSION['auth_user']['coordinator_courseHANDLED'];
                                        $ojt_status = 'Deployed';
                        ...
                        <div class="col-lg-3">
                            <div class="card">
                                <div class="stat-widget-one">
                                    ...
                                    <div class="stat-content dib">
                                        <div class="stat-text">Dropped</div>
                                        <?php
                                        $course_handled = $_SESSION['auth_user']['coordinator_courseHANDLED'];
                                        $ojt_status = 'Dropped';
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card">
                            <div class="card-title">
                                <h4>Average Performance Rating</h4>
...
$stud_sections = array_column($rows, 'stud_section');
$section_counts = array_column($rows, 'count');
?>
