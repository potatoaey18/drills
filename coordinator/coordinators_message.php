            ...
            <div class="container p-0">
              ...
              <div class="card">
                ...
                <div class="col-12 col-lg-5 col-xl-3 border-right">
                    ...
                    $course = $_SESSION['auth_user']['coordinator_courseHANDLED'];
  ...
  $(function(){
    <?php foreach ($results as $res) { ?>
      ...
      function updateMessageCount_<?php echo $res['uniqueID']; ?>() {
        $.ajax({
          type: "POST",
          url: "load_coordinator_received_NewMessage.php",
...
<script>
  function loadConversation(user_uniqueId_receiver) {
    ...
    window.location.href = 'coordinators_message.php?userUNIQUEid_receiver=' + user_uniqueId_receiver;
  }
